...
public class EncryptAsCaesar {
    ...
    protected static String encrypt(String str1, String str2) {
        ...
        for (int i = 0; i < originalText.length(); i++) {
            symbol[i] = originalText.charAt(i);                      //тут если символа нет в ALPHABET, оставляем как есть
        ...
        File file2 = new File("D:\\TextLibraryForJava\\Sharks\\Sharks2.txt");
        if (!file2.exists()) {
            try {
                file2.createNewFile();
            } catch (IOException e) {
